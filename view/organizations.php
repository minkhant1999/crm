<?php
include_once 'db.php';
$result = mysqli_query($con, "SELECT * FROM label");
$result2 = mysqli_query($con, "SELECT * FROM owner_visibility_group");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="ui fluid container">
        ...
        <!-- Modal -->
        <?php
        include("organizations_modal.php");
        ?>
        <!-- add button grid -->
        <div class="ui grid">
            <div class="left floated five wide column">
                <p><button class="ui basic button" onclick="$('.ui.basic.modal').modal('show')">Organization</button>
                </p>
            </div>

            <!-- container -->
            <div class="right floated five wide column">
                <label>4 organizations</label>
                <!-- middle dropdown -->
